...
export function TrackingWidget({ className, showIndicators = true }: { className?: string; showIndicators?: boolean }) {
            ...
            <div className="relative group hover:border-white/20 transition-colors duration-500">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-1.5 md:p-2 shadow-2xl relative">
                    <div className="flex flex-row gap-2 relative z-10">
                        ...
                        <Button
                            variant="orange"
                            className="h-10 md:h-12 px-4 md:px-8 bg-white text-primary-blue font-bold rounded-xl md:rounded-2xl text-xs md:text-sm hover:bg-slate-200 transition-colors shadow-lg whitespace-nowrap flex items-center gap-2"
                            onClick={(e) => {
