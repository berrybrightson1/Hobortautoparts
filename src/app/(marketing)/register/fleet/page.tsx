                ...
                <div className="max-w-2xl mx-auto bg-white rounded-[3rem] p-12 shadow-premium border border-slate-100">
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col gap-3">
                            ...
                            <h1 className="text-4xl font-black text-primary-blue tracking-tight">Fleet Partnership</h1>
                            <p className="text-slate-500">Register your transportation or logistics company for bulk rates and portal access.</p>
                        </div>

                        <div className="grid gap-6">
                            <div className="grid gap-2">
                                <label className="text-sm font-bold text-slate-700">Company Name</label>
                                <Input placeholder="e.g. West African Logistics" className="rounded-xl h-12" />
                            </div>
                            <div className="grid gap-2">
                                <label className="text-sm font-bold text-slate-700">Fleet Size</label>
                                <Input type="number" placeholder="Number of vehicles" className="rounded-xl h-12" />
                            </div>
                            <div className="grid gap-2">
                                <label className="text-sm font-bold text-slate-700">Business Registration Number</label>
                                <Input placeholder="GST / VAT / TIN" className="rounded-xl h-12" />
                            </div>
                        </div>

                        <Button className="w-full bg-primary-blue hover:bg-primary-blue/90 h-16 rounded-2xl text-lg font-bold">
                            Submit Application
                        </Button>
