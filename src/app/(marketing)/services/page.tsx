        ...
        <div className="flex flex-col gap-20 pt-40 pb-20">
            <section className="container mx-auto px-4 md:px-8 text-center pb-12">
                <div className="max-w-4xl mx-auto flex flex-col gap-8">
                    <h1 className="text-5xl font-black text-primary-blue md:text-7xl tracking-tight leading-[1.1]">Our Sourcing Services</h1>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2 relative z-10">
                                    <h3 className="text-2xl font-black text-primary-blue tracking-tight leading-tight">{service.title}</h3>
                                ...
                                <div className="mt-2 relative z-10">
                                    <Link href="/quote">
                                        <Button
                                            variant="link"
                                            className="p-0 text-primary-orange font-black text-base group-hover:gap-2 transition-all flex items-center gap-1"
                                        >
                                            Inquire about this
                ...
                <div className="rounded-[4rem] bg-primary-blue p-16 md:p-24 overflow-hidden relative shadow-premium text-center flex flex-col items-center">
                    <div className="relative z-10 flex flex-col items-center gap-10 max-w-2xl mx-auto">
                        <div className="text-white">
                            <h2 className="text-4xl font-black mb-6 tracking-tight md:text-5xl">Partner Network Onboarding</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <Link href="/register/fleet">
                                <Button variant="orange" size="lg" className="rounded-full px-12 h-16 text-lg font-black shadow-premium hover:scale-105 transition-transform bg-white text-primary-blue hover:bg-slate-50">
                                    Register Fleet Account
                                </Button>
                            </Link>
                            <Link href="/register/agent">
                                <Button variant="orange" size="lg" className="rounded-full px-12 h-16 text-lg font-black shadow-premium hover:scale-105 transition-transform">
                                    Join Agent Network
                                </Button>
                            </Link>
                        </div>
