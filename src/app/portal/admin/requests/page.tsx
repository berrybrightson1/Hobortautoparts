    ...
    const handleAssignment = async (requestId: string, agentId: string) => {
        ...
        try {
            ...
            await sendNotificationAction({
                ...
                type: 'request',
                link: `/portal/agent/requests?requestId=${requestId}`
            })
        ...
        try {
            ...
            try {
                ...
                await notifyAdminsAction({
                    ...
                    type: 'order',
                    link: `/portal/admin/requests?requestId=${selectedRequest.id}`
                })
            } catch (notifyErr) {
            ...
            >
                <div className="w-full bg-white h-full flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col lg:flex-row min-h-0">
                        ...
                        <div className="lg:w-[500px] bg-white flex flex-col flex-1 lg:h-full min-h-[500px]">
