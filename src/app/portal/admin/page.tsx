...
export default function AdminPortal() {
    ...
    const [stats, setStats] = React.useState([
        { label: "Total Revenue (Est)", value: "$0", icon: DollarSign, color: "text-green-500", raw: 0 },
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setStats([
                { label: "Total Revenue (Est)", value: `$${totalRevenue.toLocaleString()}`, icon: DollarSign, color: "text-green-500", raw: totalRevenue },
