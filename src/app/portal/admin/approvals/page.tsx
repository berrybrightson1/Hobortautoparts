                    ...
                    <Card key={request.id} className="border-slate-100 shadow-xl shadow-slate-200/40 rounded-[2.5rem] overflow-hidden bg-white group hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-500 border-l-4 border-l-primary-orange/20">
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3">
                                        <CardTitle className="text-2xl font-black text-slate-900 tracking-tight">{request.name}</CardTitle>
                                ...
                                <Badge className={cn(
                                    "rounded-full px-4 py-1 font-black uppercase tracking-widest text-[9px]",
                        ...
                        <CardContent className="p-8 pt-0 space-y-8">
                            <div className="space-y-4">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Submitted Documents</p>
                            ...
                            <div className="pt-4 flex items-center gap-4">
                                <Button className="flex-1 rounded-[1.5rem] h-14 bg-emerald-500 hover:bg-emerald-600 text-white font-black shadow-lg shadow-emerald-500/20 text-md transition-all hover:scale-[1.02] active:scale-[0.98]">
                                    <CheckCircle2 className="mr-2 h-5 w-5" /> Approve Account
                                </Button>
                                <Button variant="outline" className="flex-1 rounded-[1.5rem] h-14 border-slate-200 text-slate-400 hover:text-rose-600 hover:border-rose-100 hover:bg-rose-50 font-black text-md transition-all">
